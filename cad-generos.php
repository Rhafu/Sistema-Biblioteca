        ...
        <main class="main-cads">
            ...
            <div class="cadastro-geral">
                <div class="panel-body">
                    <form name="cadastro" role="form" action="./cad-generos_action.php" method="POST" enctype="multipart/form-data">

                    <div class="form-group">
                        <div class="form-group">
                            <div class="form-label"><label for="codigoAutor">Codigo do Genero</label>
                            </div>
                            <div class="form-input"><input type="text" id="codigoGenero" name="codigoGenero" placeholder="Codigo do Genero" required autofocus></div>
                        </div>

                        <div class="form-group">
                            <div class="form-label"><label for="nome">Nome</label>
                            </div>
                            <div class="form-input"><input type="text" id="nomeGenero" name="nomeGenero" placeholder="Nome do Genero" required autofocus></div>
                        </div>
