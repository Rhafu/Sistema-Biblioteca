        ...
        <main class="main-cads">
            ...
            <div class="cadastro-geral">
                <div class="panel-body">
                    <form name="cadastro" role="form" action="./cad-idiomas_action.php" method="POST" enctype="multipart/form-data">

                    <div class="form-group">
                        <div class="form-group">
                            <div class="form-label"><label for="codigoIdioma">Codigo do Idioma</label>
                            </div>
                            <div class="form-input"><input type="text" id="codigoIdioma" name="codigoIdioma" placeholder="Codigo do Idioma" required autofocus></div>
                        </div>

                        <div class="form-group">
                            <div class="form-label"><label for="nomeIdioma">Nome</label>
                            </div>
                            <div class="form-input"><input type="text" id="nomeIdioma" name="nomeIdioma" placeholder="Nome do Idioma" required autofocus></div>
                        </div>
