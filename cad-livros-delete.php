            ...
            <div class="panel-body">
                <form name="cadastro" role="form" action="./cad-livros-update_action.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-input">
                            <select name="editora" id="editora" disabled>
                                <?php
                    ...
                    <div class="form-group">
                        <div class="form-label"><label for="codigoNovo">Codigo do Livro</label>
                        </div>
                        <div><input disabled type="text" id="codigoNovo" name="codigoNovo" placeholder="Codigo do Livro" required autofocus value="<?=$livro->codigo?>"></div>
                        <input type="hidden" value="<?=$livro->codigo?>" name="codigoAntigo" >
                    </div>

                    <div class="form-group">
                        <div class="form-label"><label for="nome">Nome</label>
                        </div>
                        <div class="form-input"><input disabled type="text" id="nome" name="nome" placeholder="Nome do Livro" required value="<?=$livro->nome?>"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-input"><input disabled type="text" id="numeroPag" name="numeroPag" placeholder="Numero de Páginas" required value="<?=$livro->nmrPaginas?>"></div>
                    </div>

                    <div class="form-group">
                        <div class="form-label"><label for="quantidade">Quantidade</label>
                        </div>
                        <div class="form-input"><input disabled type="text" id="quantidade" name="quantidade" placeholder="Quantidade de Cópias" required value="<?=$livro->quantidade?>"></div>
                    </div>

                    <div class="form-group">
                        <div class="form-label"><label for="dataPublic">Data de Publicação<br></label>
                        </div>
                        <div class="form-input"><input disabled type="date" name="dataPublic" id="dataPublic" required value="<?=$livro->dataPublicacao?>"></div>
                    </div>
