...
<div class="cads-geral container">
    ...
    <main class="main-cads">
        <div class="titulo-cads">
            <h1>Cadastro de Bibliotecarios</h1>
        </div>
        <div class="linha"></div>
        <div class="linha"></div>
        <?php
        ...
        <div class="cadastro-geral">
            <div class="panel-body">
                <form name="cadastro" class="form-horizontal" role="form" action="./cad-bibliotecarios_action.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-input"><input type="text" required name="cpf" id="cpf" onkeypress="$(this).mask('000.000.000-00');" placeholder="000.000.000-00"></div>
                    </div>
