...
$cpfBibliotecario = filter_input(INPUT_GET, 'cpf', FILTER_SANITIZE_NUMBER_INT);
$bibliotecarioDao = new BibliotecarioDaoMysql($pdo);
$bibliotecario = $bibliotecarioDao->findByCpf($cpfBibliotecario);
...
<div class="cads-geral container">
    <nav>
        <?php
        require_once('./templates/cadastroLivros/menu-funcionarios.php')
        ?>
    </nav>

    <main class="main-cads">
        <div class="titulo-cads">
            <h1>Atualização de Bibliotecarios</h1>
        </div>
        <div class="linha"></div>
        <div class="linha"></div>
        <?php
        ...
        <div class="cadastro-geral">
            <div class="panel-body">
                <form name="cadastro" class="form-horizontal" role="form" action="./cad-bibliotecarios-update_action.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <div class="form-label"><label for="nome" class="control-label">Nome</label>
                        </div>
                        <div class="form-input"><input value="<?= $bibliotecario->nome ?>" type="text" id="nome" name="nome" placeholder="Nome" required autofocus></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-input"><input value="<?= $bibliotecario->email ?>" type="email" class="form-control" id="email" name="email" placeholder="Email" required></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" value="<?=$bibliotecario->senha?>" name="senhaAntiga">
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-label"><label for="cpf">CPF</label></div>
                        <div class="form-input"><input type="text" value="<?= $bibliotecario->cpf ?>" required name="cpf" id="cpf" onkeypress="$(this).mask('000.000.000-00');" placeholder="000.000.000-00"></div>
                        <input type="hidden" value="<?=$bibliotecario->token?>" name="tokenAntigo">
                    </div>

                    <div class="form-group">
                        <div class="form-label"><label for="telefone">Telefone<br></label></div>
                        <div class="form-input"><input type="text" required name="telefone" id="telefone" value="<?= $bibliotecario->telefone ?>" onkeypress="$(this).mask('(00) 00000-0000')" placeholder="(00) 00000-0000"></div>
                    </div>

                    <div class="form-group">
                        <div class="form-label"><label for="dataNasc">Data de Nascimento<br></label>
                        </div>
                        <div class="form-input"><input type="date" name="dataNasc" id="dataNasc" value="<?= $bibliotecario->dataNasc ?>" required></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" value="<?=$bibliotecario->foto?>" name="fotoAntiga">
                    </div>
