        ...
        <main class="main-cads">
            ...
            <div class="cadastro-geral">
                <div class="panel-body">
                    <form name="cadastro" role="form" action="./cad-editoras_action.php" method="POST" enctype="multipart/form-data">

                    <div class="form-group">
                        <div class="form-group">
                            <div class="form-label"><label for="codigoEditora">Codigo da Editora</label>
                            </div>
                            <div class="form-input"><input type="text" id="codigoEditora" name="codigoEditora" placeholder="Codigo da Editora" required autofocus></div>
                        </div>

                        <div class="form-group">
                            <div class="form-label"><label for="nomeEditora">Nome</label>
                            </div>
                            <div class="form-input"><input type="text" id="nomeEditora" name="nomeEditora" placeholder="Nome da Editora" required autofocus></div>
                        </div>
